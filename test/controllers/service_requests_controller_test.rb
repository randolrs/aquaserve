...
class ServiceRequestsControllerTest < ActionController::TestCase
  ...
  test "should create service_request" do
    assert_difference('ServiceRequest.count') do
      post :create, service_request: { email: @service_request.email, gallons_in_tank: @service_request.gallons_in_tank, phone_number: @service_request.phone_number, salt_water: @service_request.salt_water, zip_code: @service_request.zip_code }
    end
  ...
  test "should update service_request" do
    patch :update, id: @service_request, service_request: { email: @service_request.email, gallons_in_tank: @service_request.gallons_in_tank, phone_number: @service_request.phone_number, salt_water: @service_request.salt_water, zip_code: @service_request.zip_code }
    assert_redirected_to service_request_path(assigns(:service_request))
  end
